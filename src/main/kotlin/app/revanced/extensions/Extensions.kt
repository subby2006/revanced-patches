...
internal fun MutableMethodImplementation.injectHideCallReels(
    index: Int,
    register: Int
) {
    this.addInstruction(
        index,
        "invoke-static { v$register }, Lapp/revanced/integrations/patches/HideReelsPatch;->HideReel(Landroid/view/View;)V".toInstruction()
    )
}
...
internal fun MutableMethodImplementation.injectHideCallDonation(
    ...
    this.addInstruction(
        index,
        "invoke-static { v$register }, Lapp/revanced/integrations/patches/HideDonationCompanionPatch;->HideDonationCompanion(Landroid/view/View;)V".toInstruction()
    )
}
